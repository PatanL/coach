...
window.addEventListener("keydown", (event) => {
  ...
  // NOTE: For keyboard events, event.target is often <body> or a container; document.activeElement
  // is the more reliable signal for what the user is interacting with.
  if (event.key === "Enter") {
