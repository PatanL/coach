(function (root, factory) {
  ...
  // Escape should never trigger global overlay behavior while the user is typing.
  // We keep it narrower than Enter: if focus is on a button/link, Escape can still be a reasonable
