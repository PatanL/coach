...
window.addEventListener("keydown", (event) => {
  // Treat Enter as the primary “Back on track” action only when it’s unmodified
  // and focus isn't on an element that should handle Enter itself.
  if (event.key === "Enter") {
    const shouldTrigger = window.overlayUtils?.shouldTriggerBackOnTrackEnter
      ? window.overlayUtils.shouldTriggerBackOnTrackEnter(event)
